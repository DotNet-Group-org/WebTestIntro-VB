...
Partial Public Class BirthdayClubMemberInfo
    ...
    Protected Overloads Overrides Sub OnInit(ByVal e As EventArgs)
        ...
        'AddHandler gvBooks.SelectedIndexChanged, AddressOf presenter.SelectedBookChanged
        'AddHandler gvBooks.RowDataBound, AddressOf presenter.BookRowDataBound
        'AddHandler dsBook.Deleted, AddressOf presenter.BookDeleted
        'AddHandler dvBook.ItemDeleted, AddressOf presenter.BookItemDeleted
        'AddHandler dvBook.ItemUpdated, AddressOf presenter.BookItemUpdated
        'AddHandler dvBook.ItemInserted, AddressOf presenter.BookItemInserted
        'AddHandler btnAdjustPrice.Click, AddressOf presenter.AdjustPriceClicked
    End Sub
    ...
    Private Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        ...
        'Dim cvYear As CustomValidator = TryCast(dvBook.FindControl("cvYear"), CustomValidator)
        'If cvYear IsNot Nothing Then
        '    AddHandler cvYear.ServerValidate, AddressOf presenter.YearValidate
        'End If
    End Sub
